...
let passcodeState = null;
let passcodeEnabled = true;
let internalAuthToken = null;
 ...
 */
export function revokeAndRegeneratePasscode() {
    sessions.clear();
    rateLimitByIp.clear();
 ...
 */
export function validatePasscode(submitted) {
    if (!passcodeEnabled || !passcodeState)
        return false;
 ...
 */
export function validateInternalToken(submitted) {
...
//# sourceMappingURL=passcode-manager.js.map