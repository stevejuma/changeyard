...
import { formatDiffDelta } from "@changeyard/web-ui";
import {
...
function ReviewCommitFileRow({
	...
	return (
		...
		>
			...
			<span className="shrink-0 text-status-green">{formatDiffDelta(file.additions, "+")}</span>
			<span className="shrink-0 text-status-red">{formatDiffDelta(file.deletions, "-")}</span>
		</button>
	);
}
