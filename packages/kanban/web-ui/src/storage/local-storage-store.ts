export enum LocalStorageKey {
	...
	GitHistoryDiffContentPanelWidth = "kanban.git-history-diff-content-panel-width",
	...
	DetailFileTreeViewMode = "kanban.detail-file-tree-view-mode",
	ChangeDetailFileTreeViewMode = "kanban.change-detail-file-tree-view-mode",
	ReviewFileTreeViewMode = "kanban.review-file-tree-view-mode",
	GitDiffFileTreeViewMode = "kanban.git-diff-file-tree-view-mode",
	ChangeBoardAllFilesViewMode = "kanban.change-board-all-files-view-mode",
	ChangeBoardCommitFilesViewMode = "kanban.change-board-commit-files-view-mode",
...
export const LAYOUT_CUSTOMIZATION_LOCAL_STORAGE_KEYS = [
	...
	LocalStorageKey.GitHistoryDiffContentPanelWidth,
	...
	LocalStorageKey.DetailFileTreeViewMode,
	LocalStorageKey.ChangeDetailFileTreeViewMode,
	LocalStorageKey.ReviewFileTreeViewMode,
	LocalStorageKey.GitDiffFileTreeViewMode,
	LocalStorageKey.ChangeBoardAllFilesViewMode,
	LocalStorageKey.ChangeBoardCommitFilesViewMode,
