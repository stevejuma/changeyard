// Service worker for the ChangeYard PWA.
...
<div class="container">
  ...
  <h3>Waiting for ChangeYard</h3>
  <p>Run <code style="background:#2D3339;padding:2px 6px;border-radius:4px;font-size:13px">changeyard ui</code> in your terminal to start the server.</p>
