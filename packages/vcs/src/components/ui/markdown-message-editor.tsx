...
import { useTheme } from "@/utils/vcs-theme";
		...
		>
			...
			{activeMode === "source" ? (
				<textarea
					ref={textareaRef}
					className={cn(
						"block w-full resize-y border-0 bg-surface-0 px-4 py-3 text-sm leading-relaxed text-text-primary outline-none focus:ring-2 focus:ring-inset focus:ring-accent",
