...
- 2026-06-13: `npm --workspace @changeyard/vcs run test` passed with 35 tests.
- 2026-06-13: `npm --workspace @changeyard/vcs run typecheck` passed.
...
- 2026-06-13: `npm --workspace @changeyard/vcs run test` passed with 35 tests.
- 2026-06-13: `npm --workspace @changeyard/vcs run typecheck` passed.
- 2026-06-13: `npm --workspace @changeyard/kanban run typecheck` passed.
- 2026-06-13: `npm run build:cli` passed.
...
- 2026-06-14: `node --test dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-git-workspace.test.js` passed after `npm run build:cli`.
- 2026-06-14: Added JJ workspace tests for multiple applied stacks and hunk-selection ownership gating.
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-jj-workspace.test.js` passed with 8 JJ workspace tests.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "commit message edit"` passed.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 12 fixture-backed tests after adding commit-edit coverage.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-cross-provider-capabilities.test.js` passed with 10 backend tests after JJ conflict mapping.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-jj-preview.test.js dist/tests/vcs-jj-apply.test.js` passed with 47 JJ backend preview/apply/workspace tests.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 49 tests after selected committed file uncommit support.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after selected committed file uncommit support.
- 2026-06-14: Added focused JJ workspace preview coverage for working-copy file discard.
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-jj-workspace.test.js` passed with 10 JJ workspace tests after discard bridging.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 35 tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed.
- 2026-06-14: `npm run build:cli` passed.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-cross-provider-capabilities.test.js` passed with 14 backend workspace/capability tests after JJ file movement bridging.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 47 tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed.
...
- 2026-06-14: `npm run build:cli` passed after JJ move-commit support.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after JJ move-commit support.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after JJ move-commit support.
...
- 2026-06-14: `npm run build:cli` passed after JJ selected-file split support.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after JJ selected-file split support.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after JJ selected-file split support.
...
- 2026-06-14: `npm run build:cli` passed after JJ working-copy hunk restore/discard support.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after JJ working-copy hunk restore/discard support.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after JJ working-copy hunk restore/discard support.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 49 tests after JJ working-copy hunk restore/discard support.
...
- 2026-06-14: `npm run build:cli` passed after JJ committed-hunk split/move/uncommit support.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after adding the committed-hunk capability.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after adding the committed-hunk capability to the runtime schema.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 50 tests after committed-hunk capability validation.
...
- 2026-06-14: `npm run build:cli` passed after JJ committed-hunk discard/restore support.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 50 tests after committed-hunk discard/restore capability coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after committed-hunk discard/restore support.
...
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after committed-hunk discard/restore support.
...
- 2026-06-14: `npm run build:cli` passed after JJ stack parent-rebase support.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 50 tests after stack membership preview-policy changes.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after stack membership preview-policy changes.
...
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after stack membership preview-policy changes.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Workspace applies and unapplies"` passed after preview-confirmed JJ stack membership.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 16 fixture-backed tests after preview-confirmed JJ stack membership.
- 2026-06-13: `npm --workspace @changeyard/vcs run typecheck` passed.
- 2026-06-13: `npm --workspace @changeyard/vcs run test` passed with 35 tests.
- 2026-06-13: `npm --workspace @changeyard/kanban run typecheck` passed.
- 2026-06-13: `npm run build:cli` passed after simplifying the non-JJ fallback provider path.
...
- 2026-06-14: `npm run build:cli` passed after Git operation wiring.
- 2026-06-14: `node --test dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-git-workspace.test.js` passed with 9 tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after UI capability-gating adjustments.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 35 tests.
- 2026-06-14: `npm run build:cli` passed after Git restore/discard support.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "normal Git"` passed.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-git-workspace.test.js` passed with 14 Git workspace tests.
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-cross-provider-capabilities.test.js dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-git-workspace.test.js` passed with 23 backend workspace tests.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-git-workspace.test.js` passed with 15 Git workspace tests.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-git-workspace.test.js` passed with 16 Git workspace tests.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-git-workspace.test.js` passed with 17 Git workspace tests.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after Git hunk restore/discard support.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after adding `supportsHunkRestoreDiscard` to the runtime VCS schema.
- 2026-06-14: `npm run build:cli` passed after Git hunk restore/discard support.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 49 tests after hunk capability validation.
...
- 2026-06-14: `npm run build:cli` passed after Git selected-file movement support.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after Git selected-file movement support.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after Git selected-file movement support.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after capability gating changes.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 35 tests after capability gating changes.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "normal Git"` passed.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 13 fixture-backed tests.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after Workspace naming cleanup.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "applies and unapplies"` passed.
...
- 2026-06-14: `npm run build:cli` passed after adding the Git Branches projection.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after Branches label and applied-state cleanup.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "normal Git"` passed with Workspace and Branches normal Git coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 49 tests after Git Branches projection and label cleanup.
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-git-workspace.test.js dist/tests/vcs-cross-provider-capabilities.test.js` passed with 19 backend Git/capability tests after Git Branches projection.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Console opens"` passed after the console stop-state fix.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 16 fixture-backed JJ and Git tests after Git Branches projection and console stop-state fix.
...
- 2026-06-14: `npm run build:cli` passed after adding the neutral Branches data backend path.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after adding `vcs.branchesData` to the runtime router.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after switching Branches to the neutral hook/type.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Branches"` passed with JJ and normal Git Branches coverage through the neutral route.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after Branches unsupported-control gating.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after Branches unsupported-control gating.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Branches"` passed after Branches unsupported-control gating.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 40 tests after adding the neutral drag/drop model.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after adding the neutral drag/drop model.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 41 tests after adding capability-aware drop validation.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after adding capability-aware drop validation.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after DOM drag/drop wiring.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 41 tests after DOM drag/drop wiring.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Workspace drag and drop previews"` passed.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 9 fixture-backed tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after adding E2E selectors and coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 41 tests after adding E2E selectors and coverage.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after invalid drop-target visual state.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 42 tests after invalid drop-target visual state.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Workspace .*drag|invalid drop"` passed with 2 tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 10 fixture-backed tests.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after hunk drag-source wiring.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 43 tests after hunk diff parser coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Workspace .*drag|invalid drop|hunk drag"` passed with 3 tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 11 fixture-backed tests.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "committed file-to-commit"` passed.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Workspace (drag|hunk|visibly marks invalid drop)"` passed with 4 drag-focused tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after committed-file drag/drop coverage.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "normal Git"` passed after Git drag/drop coverage.
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-cross-provider-capabilities.test.js dist/tests/vcs-git-workspace.test.js dist/tests/vcs-jj-workspace.test.js` passed with 31 backend workspace/capability tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 47 tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after Git drag/drop coverage.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 49 tests after create-stack drop modeling.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after create-stack drop modeling.
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-cross-provider-capabilities.test.js dist/tests/vcs-git-workspace.test.js dist/tests/vcs-jj-workspace.test.js` passed with 31 backend workspace/capability tests.
- 2026-06-14: `npm --workspace @changeyard/kanban run typecheck` passed after adding `supportsCreateStack` to the runtime VCS schema.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "committed file-to-working-copy"` passed.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after post-apply diff preservation.
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-git-workspace.test.js` passed with 17 Git workspace tests after rewritten affected commit ids.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "normal Git"` passed after post-apply diff preservation coverage.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after committed-hunk drag/drop E2E coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "committed hunk-to-commit"` passed after committed-hunk drag/drop E2E coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Workspace (drag|hunk|visibly marks invalid drop)"` passed with 5 drag-focused tests after committed-hunk drag/drop E2E coverage.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after explicit invalidation tagging.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 44 tests after invalidation coverage.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-git-workspace.test.js` passed with 14 backend provider tests.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-git-workspace.test.js` passed with 15 backend provider tests.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-git-workspace.test.js` passed with 16 backend provider tests.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "commit message edit"` passed after Workspace and Branches refresh assertions.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 45 tests after preview-policy coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after Workspace lane-removal preview gating.
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-cross-provider-capabilities.test.js dist/tests/vcs-jj-workspace.test.js dist/tests/vcs-git-workspace.test.js` passed with 26 backend workspace tests.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 46 tests after watcher invalidation coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after exporting the watcher tag mapper.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 47 tests after stale-preview coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after stale-preview apply gating.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after Branches preview gating.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 47 tests after Branches preview gating.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "Workspace applies a stack"` passed after preserving the JJ low-risk Branches apply flow.
...
- 2026-06-14: Added `scripts/create-vcs-git-fixture.ts` and `npm run vcs:git-fixture` for deterministic normal Git provider fixtures.
- 2026-06-14: Verified Git fixture generation with `npm run vcs:git-fixture -- <tmp>/repo --force --json`.
...
- 2026-06-14: `npm run build:cli` passed after adding the Git fixture and detect fix.
...
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 43 tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 44 tests after RTK invalidation coverage.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 11 fixture-backed tests.
- 2026-06-14: `npm run build:cli` passed.
- 2026-06-14: `node --test dist/tests/vcs-detect.test.js dist/tests/vcs-git-workspace.test.js` passed with 11 tests.
...
- 2026-06-14: `npm run build:cli && node --test dist/tests/vcs-cross-provider-capabilities.test.js` passed.
...
- 2026-06-14: Verified JJ fixture generation with `npm run vcs:fixture -- <tmp>/repo --force --json`; output included expected cloud-observability, export-json, and query-filtering stacks plus the README working-copy file.
- 2026-06-14: Added Playwright E2E coverage for neutral Workspace commit-message editing through the preview/apply dialog.
- 2026-06-14: `npm --workspace @changeyard/vcs run typecheck` passed after commit-edit UI wiring.
- 2026-06-14: `npm --workspace @changeyard/vcs run test` passed with 44 tests after commit-edit UI wiring.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e -- --grep "commit message edit"` passed.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 12 fixture-backed tests.
- 2026-06-14: `npm --workspace @changeyard/vcs run e2e` passed with 13 fixture-backed tests after adding normal Git Workspace coverage.
